/* ======================================================================
   ...
   Purpose: To understand how parameters are passed from the CLI to the
				function, main().
	Tasks:
	...
	A. At a terminal, type
		$ gcc mainArguments.c -o mainArguments.exe 
		$ ./mainArguments.exe [OPTIONS]
	----------------------------------------------------------------------
	...
	A. sprintf()
		...
		A.3 Return Value:
			** The number of characters printed (excluding the null byte 
				used to end output to strings)., on success and 
